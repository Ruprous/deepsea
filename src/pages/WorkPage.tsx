...
const allTypes = [
  'ALL',
  ...Array.from(new Set(allWorks.flatMap(w => w.types)))
...
export default function WorkPage() {
  ...
  const filtered = selectedType === 'ALL'
    ? allWorks
    : allWorks.filter(w => w.types.includes(selectedType))
          ...
          {filtered.map(work => (
            ...
            >
              <div
                ...
                onMouseEnter={e => {
                  const img = e.currentTarget.querySelector('.work-thumb') as HTMLImageElement
