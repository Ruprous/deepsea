  ...
  return (
    ...
    >
      ...
      <div style={{ borderLeft: '1px solid rgba(0, 119, 255, 0.3)', paddingLeft: '12px', marginBottom: '24px' }}>
        ...
        {/* ── ① タグ + タグライン（横並び） ── */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px', marginBottom: '2px', flexWrap: 'wrap' }}>
          <span
            style={{
              display: 'inline-flex',
              alignItems: 'center',
      ...
      <div style={{ borderLeft: '1px solid rgba(0, 119, 255, 0.3)', paddingLeft: '12px' }}>
        ...
        {/* ── CTAボタン ── */}
        <div style={{ display: 'flex', gap: '12px', marginBottom: '28px', flexWrap: isMobile ? 'wrap' : 'nowrap' }}>
          <Link
            to="/work"
            style={{
              display: 'inline-flex',
